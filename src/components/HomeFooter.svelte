<footer
  class="flex w-screen snap-end flex-col items-center justify-center gap-3 py-5 text-xs text-zinc-500 sm:flex-row">
  ...
  <span class="cursor-pointer">Locations</span>
</footer>
