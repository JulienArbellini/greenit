  ...
  switch (params.id) {
    case "s":
      (info = {
        ...
        (Utility = {
          content:
            "With ample storage and 5,000 lbs of towing capacity, Model S is built for maximum utility. Front doors open and close automatically, Falcon Wing rear doors allow for easier loading and a trailer hitch comes standard, so you can bring your gear with you wherever you go.",
        });
    ...
    case "y":
      (info = {
        ...
        (AWD = {
          ...
          motor: "Dual Motor",
          content:
            "Tesla All-Wheel Drive has two ultra-responsive, independent electric motors that digitally control torque to the front and rear wheels—for far better handling, traction and stability control. Model Y is capable in rain, snow, mud and off-road. Compare Models",
        }),
        (Utility = {
          content:
